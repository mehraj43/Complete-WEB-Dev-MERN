console.log('Welcome to tut 45 i.e. excersie 5 solution');
...
const myJson = `{
    ...
    "results": [
      ...
      {
        "definition": "representation of something (sometimes on a smaller scale)",
        "partOfSpeech": "noun",
        "synonyms": [
          "simulation"
        ],
      ...
      {
        "definition": "a woman who wears clothes to display fashions",
        "partOfSpeech": "noun",
        "synonyms": [
          "fashion model",
          "manakin",
      ...
      {
        "definition": "someone worthy of imitation",
        "partOfSpeech": "noun",
        "synonyms": [
          "role model"
        ],
      ...
      {
        "definition": "the act of representing something (usually on a smaller scale)",
        "partOfSpeech": "noun",
        "synonyms": [
          "modeling",
          "modelling"
...
const populate = () => {
	...
	results.forEach((element) => {
		html += `<li class="list-group-item list-group-item-light"> One of the defintions of example is ${element.definition} </li> `;
